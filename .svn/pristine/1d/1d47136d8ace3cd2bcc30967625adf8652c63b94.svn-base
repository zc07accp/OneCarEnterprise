...
-(void)viewDidLoad{
    ...
    UIView *statusBarView = [[UIView alloc] initWithFrame:CGRectMake(0, -20, self.view.bounds.size.width, 20)];
         //设置成绿色
     statusBarView.backgroundColor= [UIColor colorWithRed:0.36 green:0.61 blue:0.35 alpha:1.00];
    // 添加到 navigationBar 上
    ...
    self.isSearch = NO;
    [self locationStart];
    self.searchBar = [[UISearchBar alloc]initWithFrame:CGRectMake(0, 0, kMainScreen_width, 44.0f)];
